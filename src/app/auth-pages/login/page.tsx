  ...
  useEffect(() => {
    if (oauthError) {
      const errorMessages: Record<string, string> = {
        ...
        'no_user': 'Could not retrieve your account.',
    ...
    try {
      ...
      if (!json.success) {
        ...
        if (code === 'AUTH_INVALID_CREDENTIALS') {
          ...
          setError(json.error?.message || 'Could not sign in. Please try again.');
        }
        setLoading(false);
        return;
      }

      router.push(redirect || (json.data?.onboarding_complete ? '/dashboard/home' : '/onboarding/location'));
    } catch {
    ...
    <div className="page-auth">
      <div className="w-full max-w-[420px] animate-slide-up">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-semibold text-surface-900 dark:text-white mb-2">Welcome back</h1>
          <p className="text-surface-500">Sign in to continue your job search</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/auth-pages/forgot-password" className="text-sm text-karmio-500 hover:text-karmio-600 transition-colors">
                  Forgot password?
                </Link>
              </div>
